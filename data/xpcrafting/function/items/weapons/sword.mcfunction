...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_sword"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.wooden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_sword"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.stone xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_sword"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.iron xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_sword"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.golden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_sword"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.diamond xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_sword"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.netherite xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_sword"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.wooden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_sword"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.stone xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_sword"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.iron xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_sword"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.golden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_sword"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.diamond xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_sword"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.netherite xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_sword"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.wooden.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_sword"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.stone.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_sword"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.iron.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_sword"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.golden.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_sword"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.diamond.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_sword"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.netherite.sword xpc_dummy
...
scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.sword xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_sword"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.wooden.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_sword"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.stone.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_sword"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.iron.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_sword"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.golden.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_sword"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.diamond.sword xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_sword"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.netherite.sword xpc_dummy
#getting the score to standard scale
...
data modify entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[0].components.minecraft:tool.rules.[].blocks set value "#xpcrafting:mineable/sword"
