...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_hoe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.wooden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_hoe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.stone xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_hoe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.iron xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_hoe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.golden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_hoe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.diamond xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_hoe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.netherite xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_hoe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.wooden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_hoe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.stone xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_hoe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.iron xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_hoe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.golden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_hoe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.diamond xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_hoe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.netherite xpc_dummy
...
scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.hoe xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_hoe"}] run scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.wooden.hoe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_hoe"}] run scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.stone.hoe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_hoe"}] run scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.iron.hoe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_hoe"}] run scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.golden.hoe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_hoe"}] run scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.diamond.hoe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_hoe"}] run scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.netherite.hoe xpc_dummy
...
scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.hoe xpc_dummy
#getting the score to standard scale
...
data modify entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[0].components.minecraft:tool.rules.[].blocks set value "#minecraft:mineable/hoe"
