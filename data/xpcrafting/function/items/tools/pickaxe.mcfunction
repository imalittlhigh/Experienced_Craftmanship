...
#able to mine higher quality materials? (reinforced) [ONLY ON PICKAXE]
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_pickaxe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.wooden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_pickaxe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.stone xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_pickaxe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.iron xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_pickaxe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.golden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_pickaxe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.diamond xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_pickaxe"}] run scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.netherite xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_pickaxe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.wooden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_pickaxe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.stone xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_pickaxe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.iron xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_pickaxe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.golden xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_pickaxe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.diamond xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_pickaxe"}] run scoreboard players operation %xpc.mining_speed xpc_dummy *= %xpc.mining_speed.netherite xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_pickaxe"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.wooden.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_pickaxe"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.stone.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_pickaxe"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.iron.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_pickaxe"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.golden.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_pickaxe"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.diamond.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_pickaxe"}] run scoreboard players operation %xpc.attack_damage xpc_dummy *= %xpc.attack_damage.netherite.pickaxe xpc_dummy
...
scoreboard players operation %xpc.attack_speed xpc_dummy *= %xpc.attack_speed.pickaxe xpc_dummy
...
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:wooden_pickaxe"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.wooden.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:stone_pickaxe"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.stone.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:iron_pickaxe"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.iron.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:golden_pickaxe"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.golden.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:diamond_pickaxe"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.diamond.pickaxe xpc_dummy
execute if data entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] Items[{id:"minecraft:netherite_pickaxe"}] run scoreboard players operation %xpc.attack_damage.lore xpc_dummy += %xpc.attack_damage.netherite.pickaxe xpc_dummy
#getting the score to standard scale
