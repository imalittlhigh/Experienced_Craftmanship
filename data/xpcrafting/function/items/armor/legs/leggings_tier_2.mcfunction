...
execute store result score %xpc.knockback_resistance.added_percentage xpc_dummy run random value 100..200
...
scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.diamond.leggings xpc_dummy
...
scoreboard players operation %xpc.armor xpc_dummy *= %xpc.armor.diamond.leggings xpc_dummy
...
scoreboard players operation %xpc.armor_toughness xpc_dummy *= %xpc.armor_toughness.diamond.leggings xpc_dummy
...
scoreboard players operation %xpc.armor.lore xpc_dummy += %xpc.armor.diamond.leggings xpc_dummy
#getting the score to standard scale
...
scoreboard players operation %xpc.armor_toughness.lore xpc_dummy += %xpc.armor_toughness.diamond.leggings xpc_dummy
#getting the score to standard scale
...
#Adding Lore
item modify entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] container.0 xpcrafting:items/armor/leggings_tier_2
