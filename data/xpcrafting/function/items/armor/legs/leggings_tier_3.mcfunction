...
scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.netherite.leggings xpc_dummy
...
scoreboard players operation %xpc.knockback_resistance xpc_dummy *= %xpc.knockback_resistance.netherite.leggings xpc_dummy
...
scoreboard players operation %xpc.armor xpc_dummy *= %xpc.armor.netherite.leggings xpc_dummy
...
scoreboard players operation %xpc.armor_toughness xpc_dummy *= %xpc.armor_toughness.netherite.leggings xpc_dummy
...
scoreboard players operation %xpc.armor.lore xpc_dummy += %xpc.armor.netherite.leggings xpc_dummy
#getting the score to standard scale
...
scoreboard players operation %xpc.armor_toughness.lore xpc_dummy += %xpc.armor_toughness.netherite.leggings xpc_dummy
#getting the score to standard scale
...
scoreboard players operation %xpc.knockback_resistance.lore xpc_dummy += %xpc.knockback_resistance.netherite.leggings xpc_dummy
#getting the score to standard scale
...
#Adding Lore
item modify entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] container.0 xpcrafting:items/armor/leggings_tier_3
