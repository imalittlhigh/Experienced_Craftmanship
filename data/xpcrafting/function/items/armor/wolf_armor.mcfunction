...
scoreboard players operation %xpc.armor_added xpc_dummy *= %xpc.armor.wolf xpc_dummy
...
scoreboard players operation %xpc.armor.lore xpc_dummy += %xpc.armor.wolf xpc_dummy
#getting the score to standard scale
