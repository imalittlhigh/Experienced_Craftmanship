...
scoreboard players operation %xpc.durability xpc_dummy *= %xpc.durability.diamond.boots xpc_dummy
...
scoreboard players operation %xpc.armor xpc_dummy *= %xpc.armor.diamond.boots xpc_dummy
...
scoreboard players operation %xpc.armor_toughness xpc_dummy *= %xpc.armor_toughness.diamond.boots xpc_dummy
...
scoreboard players operation %xpc.armor.lore xpc_dummy += %xpc.armor.diamond.boots xpc_dummy
#getting the score to standard scale
...
scoreboard players operation %xpc.armor_toughness.lore xpc_dummy += %xpc.armor_toughness.diamond.boots xpc_dummy
#getting the score to standard scale
...
#Adding Lore
item modify entity @n[type=chest_minecart,tag=xpc.minecart,distance=..1] container.0 xpcrafting:items/armor/boots_tier_2
